        ...
        for (T item : dataList) {
            ...
            for (int i = 0; i < fields.size(); i++) {
                try {
                    ...
                    if (fieldValue instanceof Boolean && (Boolean)fieldValue == true) {
                        fieldValue = (Object) "Masculin";
                    }
                    
                    if (fieldValue instanceof Boolean && (Boolean)fieldValue == false) {
                        fieldValue = (Object) "Feminin";
                    }
